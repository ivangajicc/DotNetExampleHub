...
namespace CommonPracticePatterns.CQS.Tests;

public class ChatRoomTest
{
    private readonly IMediator _mediator = new Mediator.Mediator();
    ...
    [Fact]
    public void A_participant_should_be_able_to_send_chat_messages_and_others_should_be_able_to_retrieves_them_after_joining()
    {
        _reagen.Join(_room1);
    ...
    private sealed class ChatModerator : Participant, ICommandHandler<SendChatMessage.Command>
    {
    ...
    private class TestMessageWriter : IMessageWriter
    {
        ...
        public void Write(IChatRoom chatRoom, ChatMessage message) => Output.Add((chatRoom, message));
    }
}
