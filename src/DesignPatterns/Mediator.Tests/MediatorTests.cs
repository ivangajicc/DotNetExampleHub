...
namespace DesignPatterns.Mediator.Tests;
...
";
    ...
    private static (TestMessageWriter MessageWritter, ConcreteColleague Colleague) CreateConcreteColleague(string name)
    {
