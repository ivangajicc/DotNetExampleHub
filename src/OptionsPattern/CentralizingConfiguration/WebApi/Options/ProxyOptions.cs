...
namespace OptionsPattern.CentralizingConfiguration.WebApi.Options;
...
public class ProxyOptions : IConfigureOptions<ProxyOptions>, IValidateOptions<ProxyOptions>
{
    ...
    void IConfigureOptions<ProxyOptions>.Configure(ProxyOptions options) => options.CacheTimeInSeconds = DefaultCacheTimeInSeconds;
